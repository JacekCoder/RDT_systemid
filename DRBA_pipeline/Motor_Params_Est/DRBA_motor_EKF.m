...
simout = sim('BLDC_EKF.slx','StartTime','0','StopTime','50');
...
% plot(output_pos);
hold on
plot(simout.theta_est*22.67/(pi/12))

figure(2)
plot(simout.omega_est)
hold on
plot(simout.omega_actual(1:50:end))

figure(3)
plot(simout.i_est)
hold on
plot(simout.i_actual(1:50:end))